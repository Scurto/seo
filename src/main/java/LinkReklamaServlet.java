 ...
 */
@WebServlet("/getLinkReklama")
public class LinkReklamaServlet extends HttpServlet {
        ...
        switch (action) {
            case "selectReklama":
                ...
                try {
                    ...
                    ResultSet rs = stmt.executeQuery("SELECT * FROM hfjq_race_info.test_video WHERE task_id='" + id + "'");
            ...
            case "insetReklama":
                ...
                try {
                    ...
                    conn = DriverManager.getConnection
                            (fullURL, user, password);
                    stmt =  conn.createStatement();
                    String query = "INSERT INTO test_video SET task_id = '" + taskId + "', prev_date='" + prevDate + "', prev_reklama='" + prevReklama + "', last_date='" + lastDate + "', last_reklama='" + lastReklama + "'";
            ...
            case "updateReklama":
                ...
                try {
                    ...
                    conn = DriverManager.getConnection
                            (fullURL, user, password);
                    stmt =  conn.createStatement();
                    String query = "UPDATE test_video SET prev_date='" + prevDate + "', prev_reklama='" + prevReklama + "', last_date='" + lastDate + "', last_reklama='" + lastReklama + "' where task_id = '" + taskId + "'";
